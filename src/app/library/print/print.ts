...
export class Print {
    ...
    public static registrationPrint(ord: string, dataSource: any, customerInfo: any) {
        ...
        total = dataSource.reduce((prev: { toString: () => string; }, curr: { Price: { toString: () => string; }; }) => {
...
<body onload="window.print();window.close();">
    ...
    <div class="content-service">
       ${dataSource.data.map((item: { ItemName: any; Quantity: any; UnitName: any; TimeUse: any; QuantityPerUse: any; UserUsing: any; ItemUsing: any; Note: null; }, i: number) => `
          <div class="row">
...
`;
    ...
    public static secretaryRePrintGroupServiceConfig(showPrice: boolean, dataSource: any, customerInfo: any, title: any) {
        let displayShowPrice: string = "unset",
            ...
            user = LocalStorageConfig.GetUser(),
            total: number = 0;
        total = dataSource.reduce((prev: { toString: () => string; }, curr: { AmountPaid: { toString: () => string; }; }) => {
            //convert string kiểu "2,222" => string "2222"
            let regex = new RegExp('[^' + String.DECIMAL_SEPARATOR + '\\d]', 'g'),
...
<body onload="window.print();window.close();">
    ...
    <div class="content-service">
        ${dataSource.map((item: { GroupServiceName: any; AmountPaid: any; RequestGroupServiceDetailList: any[]; }, i: number) => `
          <div class="row">
...
<div class="content-prescription">
    ...
    ${dataSourcePrescription.map((item: { ItemName: any; UnitName: any; TimeUse: any; ItemUsing: any; QuantityPerUse: any; Quantity: any; }, i: number) => `
          <div class="row">
